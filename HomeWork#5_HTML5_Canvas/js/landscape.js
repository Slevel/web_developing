...
function init()	{
	// инициализаци€
	current_time = 'day'; // стартовое врем€ суток
	// дневные объекты
	...
	// скорость движени€ по оси абсцисс
    var vX = 2;
	// скорость движени€ по оси ординат
    var vY = 0.2;
	// инициализаци€ canvas'a с пейзажем
	...
	//инициализаци€ сцены с анимацией
	...
	// обработка движени€ луны (если ночь)
	if (current_time == 'night')	{
	...
	// обработка движени€ солнца (если день)
	if (current_time == 'day')	{
